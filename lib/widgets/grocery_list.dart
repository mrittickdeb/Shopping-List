...
class _GroceryListState extends State<GroceryList> {
  ...
  void _loadItems() async {
    final url = Uri.https(
        'flutter-prep-aa7b7-default-rtdb.firebaseio.com', 'shopping-list.json');
  ...
  void _removeItem(GroceryItem item) async {
    ...
    final url = Uri.https('flutter-prep-aa7b7-default-rtdb.firebaseio.com',
...
class _GroceryListState extends State<GroceryList> {
  ...
  Future<List<GroceryItem>> _loadItems() async{
      final url=Uri.https('flutter-prep-aa7b7-default-rtdb.firebaseio.com','shopping-list.json');
             final response=await http.get(url);
    if(response.statusCode>=400) {
  ...
  setState(() {
    ...
    void _removeItem(GroceryItem item) async{
      ...
      final url=Uri.https('flutter-prep-aa7b7-default-rtdb.firebaseio.com','shopping-list/${item.id}.json');
      final response=await http.delete(url);
      if(response.statusCode>=400){
         setState(() {
